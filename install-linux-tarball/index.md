---
layout: page
title: Installing Swift on Linux using a tarball
---

Swift.org publishes tar archives that include a copy of the Swift compiler, lldb, and related tools.
...
These are only the distributions where these binaries have been built and tested.
